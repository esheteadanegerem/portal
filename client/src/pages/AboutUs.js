...
<br></br>
   ...
   <br></br>
        ...
        <div className='container  card pe-0 card-body'style={{width:"1000px", height:"725px",fontSize:"25px",color: 'white', borderRadius: '40px bold', backgroundColor: '#11676d',marginBottom:"135px"}} >
