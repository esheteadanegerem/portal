...
function UpdateUserStatus() {
  ...
  useEffect(
    function(){
      ...
      axios.get('https://mintportalentry.onrender.com/admin2Feedback/getFeedback')
      .then((result)=>{setFeedbacks(result.data); console.log(feedbacks)})
      .catch(err=>console.log(err))
      setLoaded(true);
    }
  
  ,[feedbacks]  // eslint-disable-next-line react/jsx-no-undef
  );
...
function updateStatus(id, newStatus){
  console.log("Clicked!")
  axios.get('https://mintportalentry.onrender.com/admin/userStatus/'+id+"-"+newStatus)
