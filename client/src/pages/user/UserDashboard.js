  ...
  return (
    <div className="container mt-5">
      <div className="row">
        ...
        {/* <button className="nav-link d-none d-lg-inline btn m-5  "  style={{backgroundColor: '#11676d', color:"#11676d", border: "solid",  borderWidth:"0.5px" , borderRadius:"10px" , fontSize: '16px',color:'white'}} onClick={Logout}>Logout</button> */}
        </div>
      </div>
      <div className="row">
