    ...
    <div className="container shadow p-4 mb-5 mt-5" style={{ background: '#2b2b2b', color: "white" ,height: "580px"}}>
      <div className="row">
        <div className="col-md-6" style={{height:"600px"}}>
          ...
          <img src={video1} alt="Potential Sector Image1" style={videoStyle} height="250px" width="300px"/>
          </div>
          <div style={{ ...videoContainerStyle, marginLeft: '70px' }}>
          <img src={video2} alt="fgkdg" style={videoStyle} height="250px" width="300px"/>
          </div>
          <div style={{ ...videoContainerStyle, marginLeft: '150px' }}>
          <img src={video3} alt="ima" style={{...videoStyle, marginBottom:"50px"}} height="250px" width="300px"/>
          </div>
