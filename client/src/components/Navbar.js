...
const Navbar = () => {
  ...
  <a className={`nav-link ${window.location.pathname === '/graph' ? 'active' : ''}`} href="/graph" onClick={closeMenu} style={{marginRight: '10px', color: 'white'}}>Reports</a>
          ...
          <div className="navbar-nav ml-auto" >
              ...
              style={{backgroundColor: "white", color:"#11676d", border: "solid", borderWidth:"0.5px" , marginRight:'5px', borderRadius:"10px", fontSize: '12px' }} 
              >Login</Link>
                    

              <Link className="nav-link d-none d-lg-inline btn " to="/register" 
              style={{backgroundColor: "white", color:"#11676d", border: "solid",  borderWidth:"0.5px" , borderRadius:"10px" , fontSize: '12px'}} 
              >Register</Link>
